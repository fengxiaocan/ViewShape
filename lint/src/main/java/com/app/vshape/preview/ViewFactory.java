...
final class ViewFactory implements LayoutInflater.Factory2{
    ...
    private static final Set<String> APPCOMPAT_VIEWS=new HashSet<>(Arrays.asList("FrameLayout",
                                                                                 "LinearLayout",
                                                                                 "RelativeLayout",
                                                                                 "TextView",
                                                                                 "ImageView",
    ...
    public View onCreateView(View parent,String name,Context context,AttributeSet attrs){
        ...
        //if is a custom view
        if(result==null){
            result=ViewInflaterFactory.createView(name,getContext(),attrs);
        }

        if(result!=null){
            if(attrs.getAttributeValue(sAutoNs,"shapeType")!=null||attrs.getAttributeValue(sAutoNs,"shapeSolidSize")!=
                                                                   null||attrs.getAttributeValue(sAutoNs,
                                                                         ...
                                                                         null||attrs.getAttributeValue(sAutoNs,
                                                                               ...
                                                                               null||attrs.getAttributeValue(sAutoNs,
                                                                                                             "shapeSolidColor")!=
                                                                                     null||attrs.getAttributeValue(
                    sAutoNs,
                    "shapeStrokeWidth")!=null||attrs.getAttributeValue(sAutoNs,"shapeStrokeColor")!=null||
               attrs.getAttributeValue(sAutoNs,"shapeStokeDashWidth")!=null||attrs.getAttributeValue(sAutoNs,
                                                                                                     "shapeStokeDashGap")!=
                                                                             null||attrs.getAttributeValue(sAutoNs,
                                                                                                           "shapeCornerRadius")!=
                                                                                   null||
               attrs.getAttributeValue(sAutoNs,"shapeCornerRadiusTopLeft")!=null||attrs.getAttributeValue(sAutoNs,
                                                                                                          "shapeCornerRadiusTopRight")!=
                                                                                  null||attrs.getAttributeValue(sAutoNs,
                                                                                                                "shapeCornerRadiusBottomLeft")!=
                                                                                        null||attrs.getAttributeValue(
                    sAutoNs,
                    "shapeCornerRadiusBottomRight")!=null||attrs.getAttributeValue(sAutoNs,"shapeGradientType")!=null||
               attrs.getAttributeValue(sAutoNs,"shapeGradientAngle")!=null||attrs.getAttributeValue(sAutoNs,
                                                                                                    "shapeGradientStartColor")!=
                                                                            null||attrs.getAttributeValue(sAutoNs,
                                                                                                          "shapeGradientCenterColor")!=
                                                                                  null||attrs.getAttributeValue(sAutoNs,
                                                                                                                "shapeGradientEndColor")!=
                                                                                        null||attrs.getAttributeValue(
                    sAutoNs,
